# Hi there 👋, I'm Anna Klimenko

### Frontend Developer | React & E-Commerce Web Applications | UI/UX Specialist

I am a Frontend Developer specializing in modern React applications, interactive E-commerce interfaces, and clean, responsive UI/UX design. I bridge the gap between complex Figma designs and high-performing, scalable web applications using the 2026 tech stack. Open for freelance opportunities and international collaboration! 🚀

---

## 🛠 Tech Stack & Skills

* **Frameworks & Libraries:** React (Vite), Tailwind CSS, Lucide Icons
* **Core Languages:** JavaScript (ES6+), TypeScript, HTML5, CSS3 / SCSS
* **Architecture & Data:** REST API Integration, LocalStorage API, SQL & Database Fundamentals, Asynchronous Logic (Promises / Mock AI), BEM
* **Tools & Workflow:** Git, GitHub, VS Code, Figma (Pixel-Perfect Translation), Mobile-First Responsive Design
...
* **Links:** [Live Demo](https://ai-ecommerce-card-generator.vercel.app/) | [Source Code](https://github.com/Anna-Klimenko13/ai-ecommerce-card-generator)
...
* **Links:** [View Repositories](https://github.com/Anna-Klimenko13?tab=repositories)
...
* **Telegram:** [@Anna_Klimenko13](https://t.me/Anna_Klimenko13)
* **Freelance Profile:** [Freelancehunt Portfolio](https://freelancehunt.com/freelancer/anna_klimenko13.html#portfolio)
